...
public class Project2 {
	...
	public static void main(String[] args) {
	    ...
	    if (total <= 8) {
			...
			score = "Whoa! You may be so lazy that you may need help!";
		}	
	...
	public static int question10(Scanner console) {
		...
		//If no, +0 points
		//Print question:
		System.out.print("Has your computer run out of batter but you let it die anyway, because you did not want to get up, find the charger, and then plug it in (yes or no)?");
		//Console enters answer
